    ...
    <div className="flex flex-col items-center justify-center h-screen ">
      <div className="bg-white rounded-lg shadow-2xl p-8 md:p-20 w-full max-w-md md:max-w-[744px] h-auto md:h-[426px]">
        <div className="p-8">
          ...
          {recommendation ? <p className="text-center font-bold text-gray-700 mt-4">{recommendation}</p> : <p className="text-center text-gray-700 mt-4">Tidak ada rekomendasi yang tersedia.</p>}
